...
export const fragmentFileSchema = z.object({
  path: z
    .string()
    .describe('Relative path to the generated file, including the file name.'),
  content: z.string().describe('Complete contents of the generated file.'),
  purpose: z
    .string()
    .optional()
    .describe('Short reason this file exists in the generated project.'),
})

export const supabaseMigrationSchema = z.object({
  name: z
    .string()
    .describe('Short descriptive migration name, for example create_profiles_table.'),
  description: z
    .string()
    .describe('One sentence explaining what this migration changes.'),
  query: z
    .string()
    .describe('Complete PostgreSQL migration SQL to apply through Supabase.'),
})
...
export const fragmentSchema = z.object({
  ...
  files: z
    ...
    .optional()
    .describe(
      'All generated project files. Use this for multi-file apps. Include the main file here too.',
    ),
  supabase_migrations: z
    .array(supabaseMigrationSchema)
    .optional()
    .describe(
      'Supabase database migrations required by the generated project. Leave empty unless the app needs database schema changes.',
    ),
